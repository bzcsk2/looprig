...
| 3 | ~~`OS-00`、`OS-10`~~ | 已完成 |
| 4 | ~~`OS-14`、`OS-15`~~ | 已完成 |
| 5 | ~~`OS-11`（子进程终止 + system-prompt）~~ | 已完成 |
| 6 | ~~`OS-16`~~ | 已完成 |
| 7 | ~~`OS-17 三平台 CI scaffold`~~ | 已加入；待 push 后检查运行结果 |
| 8 | `OS-12/13` macOS/Windows 原生验收 | 代码层面已就绪，需在原生环境验收。 |
...
P5.5、AUD-02/03/05/07/08、T21-R、P3-R、S1/S2、ST2/ST3/ST4、CL-10/11/12/20/21/30/31/32/40/41/42/50/51/52、OS-00/10/11/14/15/16 均已完成。OS-17 三平台 CI scaffold 已加入。全量 787 测试通过，0 失败，共 56 个测试文件。

下一步：在 macOS 和 Windows 原生环境完成 `OS-12/13` 验收。`OS-12/13` 代码已全部就绪，只需在目标平台运行 `bun run typecheck` 和 `bun test` 并验证平台功能路径。
