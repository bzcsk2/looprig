...
/** 可抢救的 assistant 响应片段 */
export interface SalvableAssistantResponse {
  content?: string | null
  toolCalls?: ToolCall[]
  finishReason?: string
}
...
export function parseTextFormatToolCalls(content: string): ToolCall[] {
 ...
 */
export function salvageTextToolCallsInResponse(response: SalvableAssistantResponse): SalvableAssistantResponse {
 ...
 */
export function resolveSalvagedLlmResponse(raw: SalvableAssistantResponse): SalvableAssistantResponse {
