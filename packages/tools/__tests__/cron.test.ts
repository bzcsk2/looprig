...
describe("Cron deleteJob", () => {
  it("should delete a job and its schedule line", () => {
    ...
    expect(result[0]).toBe("# covalo-job:keep-me")
  })

  it("should not modify lines when job not found", () => {
    const lines = ["# covalo-job:existing", "0 * * * * /bin/true"]
